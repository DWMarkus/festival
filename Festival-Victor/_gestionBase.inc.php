...
{
   $req="select distinct id, nom, nombreChambresOffertes, nombreChambres from Etablissement, Attribution where id = idEtab order by id";
   return $req;
}

function AttributionsGroupe()
{
   $req="select distinct Attribution.idEquipe, Etablissement.nom, nombreChambresOffertes, nombreChambres, Equipe.nom as Enom from Etablissement, Attribution, Equipe where Etablissement.id = idEtab and Equipe.id = idEquipe order by idEtab";
   return $req;
}
