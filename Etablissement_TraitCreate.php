...
$req=creerEtablissement($id, $nom, $adresse, $cp, 
...
$res=$bdd->exec($req);
  if (!$res) 
  {
    echo "<br><center><h5>Création échouée.</h5><a href='EtablissementsListe.php'>Retour</a></center>.";
  }
  else
  {
    echo "<br><center><h5>Création réussie.</h5><a href='EtablissementsListe.php'>Retour</a></center>.";
  }
